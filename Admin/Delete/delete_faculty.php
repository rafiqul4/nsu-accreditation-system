...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <center>
        ...
        require_once("../../connection.php");
            ...
            if($_row==0){
                echo "<center><h1 class='my-5 lev'>No faculty found</h1></center>";
            }
            else{
                ?>
                <h3 class='lev'>List of faculties</h3></br>
                <div class='search'>
    ...
    $("#search").on("keyup",function(){
      $.ajax({
        type:'POST',
        url:'faculty_search.php',// live search file 6theke naam dibo
        data:{
          name:$("#search").val(),
        },
        success:function(data){
