...
if(@$_GET['Empty']==true){
      ...
      <form action="add_faculty_process.php" method="POST" >
        <div>
          <input type="text" name="initial" maxlength="6" Placeholder='Faculty initial' class='dn'>
        </div>
        </br>
        <div>
        ...
        <br>
        <div><input type="password" name="password" Placeholder='Password' class='dn'></div><br>
        ...
        <div><label for="">Birthdate : </label><input type="date" class="bod" name="dateofbirth" Placeholder='Birthdate' max='2004-01-01' class='bod'></div><br>
      ...
      <center></br><div><label><b>OR</b></label></div>
      <h6><a class='' href="../Images/Faculty_add.png" target="_blank"><u>Excel Format</u></a></h6>
      <form method='POST' action='add_facultyxl_process.php' name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data"> 
