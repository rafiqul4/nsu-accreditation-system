...
<center>
    ...
    <table class='tab1'>
        <tfoot class='tfo'><tr class='tr1'><td class='td1' colspan='14'><button class='set'><a class='lab' href='assessment.php'>Next</a></button></tr></tfoot>
        <tr class='tr1'>
    ...
    <br>
    <form method='POST'><button class='aback' name='no'>Back</button><form>
</center>
<?php
if(isset($_POST['no'])){
    $del="DELETE from po where section='$section'";
