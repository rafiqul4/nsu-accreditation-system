...
$dep=$_SESSION['dep'];
$query="SELECT * from section as s,course as c where (c_code LIKE '%$search_value%' OR section = '$search_value' OR fac_id like '%$search_value%') and s.c_code=c.code and c.department='$dep' and semester='$sem' and  semester='$sem'";
