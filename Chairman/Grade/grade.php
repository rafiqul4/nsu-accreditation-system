...
<br>
<button class='aback'><a class='lab' href='section.php'>Back</a></button>&nbsp&nbsp&nbsp&nbsp<button name='done' class='aback'><a class='lab' href='review.php'>Next</a></button>
</body>
</html>