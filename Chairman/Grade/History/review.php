...
<button name='back' class='aback' onclick="return sure()"><a class='lab' href='grade.php'>Back</a></button>&nbsp&nbsp&nbsp&nbsp<button name='done' class='aback'><a class='lab' href='summary.php'>Next</a></button>
</center>
</body>
</html>